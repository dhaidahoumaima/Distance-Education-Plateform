...
import { logoutEnseignant,getID } from './LoginEnseignant/loginEnseignant';
...
export default class HeaderEnseignant extends React.Component {
  constructor(props) {
    super(props);
  ...
  return (
    ...
    <Nav className="col-sm-4 row justify-content-center" >  
      ...
      <Nav.Link eventKey={2} onClick={this.profil}  > <BsFillPersonFill/> Profil  |   </Nav.Link>      
        <Nav.Link eventKey={2} onClick={() => logoutEnseignant()}> < AiOutlineLogout/> Se déconnecter</Nav.Link>
      </Nav>
    </Navbar.Collapse>
  </Navbar>
